...
export const LoginPage = () => {
  ...
  const handleLogin = (e) => {
    ...
    const findUser = (usersArray) =>
      usersArray.find((user) => user.email === data.email && user.password === data.password);
      ...
      <div className="mx-auto flex w-full flex-col justify-center px-5 pt-0 md:max-w-[50%]  lg:px-6">
        <div className="mt-10 w-fit text-white">
          <div className="flex w-fit items-center lg:pl-0 lg:pt-0 xl:pt-0">
            <div
              className="hover:bg-gray-700 duration-150 rounded-full p-[3px] me-3"
